"""MySQL repository implementations for StudyAgent."""
...
from study_agent_domain import Chunk, ChunkType, Document, DocumentAsset, DocumentStatus, DocumentType, Project
...
if __name__ == "__main__":
    ...
    mysql_config = MySQLConnectionConfig(
        host=os.getenv("STUDY_AGENT_MYSQL_HOST", "127.0.0.1"),
        port=int(os.getenv("STUDY_AGENT_MYSQL_PORT", "3306")),
        user=os.getenv("STUDY_AGENT_MYSQL_USER", "root"),
        password=os.getenv("STUDY_AGENT_MYSQL_PASSWORD", ""),
        database=os.getenv("STUDY_AGENT_MYSQL_DATABASE", "study_agent"),
    )
    ...
    test_asset = DocumentAsset(
        ...
        page_number=1,
        file_path=str(Path.cwd() / "StudyAgentCache" / "sample.png"),
