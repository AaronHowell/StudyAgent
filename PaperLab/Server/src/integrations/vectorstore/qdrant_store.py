...
from domain import Chunk, ChunkType, DocumentAsset, DocumentProfile, ScoredId
...
if __name__ == "__main__":
    ...
    qdrant_config = QdrantConnectionConfig(
        ...
        collection_name=f"paperlab_chunks_test_{test_collection_suffix}",
        asset_collection_name=f"paperlab_assets_test_{test_collection_suffix}",
        document_collection_name=f"paperlab_documents_test_{test_collection_suffix}",
    )
